...
public:
    ...
    static int run(sf::RenderWindow& parentWindow) {
        ...
        sf::Text text3;
        text3.setFont(font);
        text3.setString(L"환웅 호감도 : " + std::to_wstring(heart)); // 와이드 문자열 사용
